                        ...
                        <form  action="" id="FormData" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                          ...
                          <div class="mb-4">
                            ...
                            <div class="mb-6">
                                ...
                                <input class="shadow appearance-none border border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" name="start" id="Start-D" required type="text" >
                              </div>
                              ...
                              <div class="mb-6">
                                ...
                                <input class="shadow appearance-none border border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" name="end" id="end-D" required type="text" >
                              </div>
